...
/**
 * Unit tests of class WeightedGrayscaleProcess
 */
public class WeightedGrayscaleProcessTest {
    ...
    public void testOneChannel() {
        ...
        WeightedGrayscaleProcess process = new WeightedGrayscaleProcess(image, 0.33, 0.33, 0.33);
        process.process();
