...
/**
 * Unit tests of class CardinalConvolutionProcess
 */
public class CardinalConvolutionProcessTest {
    ...
    private static class Mock extends CardinalConvolutionProcess {
